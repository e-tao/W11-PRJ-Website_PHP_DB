...
INSERT INTO `page` (`pageId`, `pageTitle`, `pageName`, `pageContent`) VALUES
	...
	(13, 'Login Fail', 'loginfail', ' <div id="img-fail">\r\n            <img src="./img/fail.jpg">\r\n            </div>\r\n            <div id="txt-fail">\r\n            <h2>OOPS!</h2>\r\n            <p>We work so hard to avoid displaying this page, but unforturnately something went wrong.</p>\r\n            <p>Error: <em>The password is incorrect or user does not exist</p>\r\n            <p>Please try again.</em></p>\r\n        </div>');
...
-- Dumping data for table w11_assignment_ChengTao.user: ~2 rows (approximately)
/*!40000 ALTER TABLE `user` DISABLE KEYS */;
INSERT INTO `user` (`userId`, `username`, `passHash`, `cookieHash`) VALUES
	(4, 'Ethan', '$2y$10$EDnxi1ihQx5ITOJbZlFWpeQyk0XWPxsaJ0HnJQT27TqFzW6ouvYlS', '$2y$10$2IjoO.9fImIzZuL9J7QJ8.GyZuOkv/3ygYubU9xnrp6XJZTLgWc.S'),
	(13, 'Bob', '$2y$10$dbX2PTlXIQ6aVQs1JqO53OXCJ3EtBZZCePimi1u/Pf1Z.RoY9H29u', '$2y$10$WeHRmBvGknajOO0VwNCMheK3ETbDaqzd5nPqzYk9oIQQ5gR4izfFi');
